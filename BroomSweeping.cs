...
public class BroomSweeping : MonoBehaviour
{
    ...
    void Update()
    {
        if (IsActionKeyPressed() && ToolSwitcher.ActiveToolIndex != 1 && ToolSwitcher.ActiveToolIndex != 3 && ToolSwitcher.ActiveToolIndex != 4) //These are the tools that will NOT bob when mouse is held down.
        {
            isSweeping = true;
        }
